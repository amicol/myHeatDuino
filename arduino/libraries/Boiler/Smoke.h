...
MyMessage msgSmoke(MQ_SENSOR_CHILD_ID, V_LEVEL);
class Smoke
{
private:
...
Ianput:   raw_adc - raw value read from adc, which represents the voltage
Output:  the calculated sensor resistance
Remarks: The sensor and the load resistor forms a voltage divider. Given the voltage
         across the load resistor and its resistance, the resistance of the sensor
         could be derived.
************************************************************************************/
float Smoke::MQResistanceCalculation(int raw_adc)
{
...
************************************************************************************/
float Smoke::MQCalibration(int mq_pin)
{
  int i;
  float val=0;
...
************************************************************************************/
int Smoke::MQGetGasPercentage(float rs_ro_ratio, int gas_id)
{
  if ( gas_id == GAS_LPG ) {
...
Remarks: By using the slope and a point of the line. The x(logarithmic value of ppm)
         ...
         value.
************************************************************************************/
int  Smoke::MQGetPercentage(float rs_ro_ratio, float *pcurve)
{
...
void Smoke::presentation()
{
present(MQ_SENSOR_CHILD_ID,S_AIR_QUALITY);
wait(DWELL_TIME);
}
...
void Smoke::update()
{
  ...
  //if (valMQ != lastMQ) {
      send(msgSmoke.set((int)ceil(valMQ)),1);
      wait(DWELL_TIME);
      lastMQ = ceil(valMQ);
  //}
